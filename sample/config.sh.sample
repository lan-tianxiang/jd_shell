## Version: v3.3.0
## Date: 2021-03-16
## Update Content: 新增宠汪汪赛跑自动助力自己的接口（默认开启）  
...
################################## 定义京东环球挑战赛活动互助（选填） ##################################
## 具体填法及要求详见：https://github.com/lan-tianxiang/jd_shell/wiki/
## 环球挑战赛
